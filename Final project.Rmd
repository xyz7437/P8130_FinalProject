...
cat("Mallow's CP: ",Cp(model2,S2=summary(model2)$sigma^2),"\nAIC: ", AIC(model2,k=2),"\nBIC: ",AIC(model2,k=log(n)), "\n")
...
cat("Mallow's CP: ",Cp(model3,S2=summary(model3)$sigma^2),"\nAIC: ", AIC(model3,k=2),"\nBIC: ",AIC(model3,k=log(n)) , "\n")
...
cat("Mallow's CP: ",Cp(model4,S2=summary(model4)$sigma^2),"\nAIC: ", AIC(model4,k=2),"\nBIC: ",AIC(model4,k=log(n)) , "\n")
...
cat("Mallow's CP: ",Cp(model5,S2=summary(model5)$sigma^2),"\nAIC: ", AIC(model5,k=2),"\nBIC: ",AIC(model5,k=log(n)) , "\n")
