...
cv_df = 
  ...
  mutate(
    rmse_model1 = map2_dbl(mult_fit_back_without, test, ~rmse(model = .x, data = .y)),
    rmse_model2 = map2_dbl(mult_fit_back_without_trans, test, ~rmse(model = .x, data = .y)),
    rmse_model3 = map2_dbl(mult_fit_back_without_vif, test, ~rmse(model = .x, data = .y)),
    rmse_model4 = map2_dbl(mult_fit_back_without_int, test, ~rmse(model = .x, data = .y)))

cv_df %>%
  dplyr::select(rmse_model1,rmse_model2,rmse_model3,rmse_model4) %>%
